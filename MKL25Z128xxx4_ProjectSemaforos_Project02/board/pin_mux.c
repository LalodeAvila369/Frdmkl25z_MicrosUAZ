...
board: FRDM-KL25Z
pin_labels:
- {pin_num: '13', pin_signal: ADC0_DP0/ADC0_SE0/PTE20/TPM1_CH0/UART0_TX, label: 'J10[1]', identifier: NGreen;SGreen}
- {pin_num: '14', pin_signal: ADC0_DM0/ADC0_SE4a/PTE21/TPM1_CH1/UART0_RX, label: 'J10[3]', identifier: SYellow}
...
- {pin_num: '33', pin_signal: PTA13/TPM1_CH1, label: 'J2[2]/D8', identifier: WVuelta;WBlue;PeopleSense}
- {pin_num: '43', pin_signal: ADC0_SE8/TSI0_CH0/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0, label: 'J10[2]/A0', identifier: NGreen}
- {pin_num: '44', pin_signal: ADC0_SE9/TSI0_CH6/PTB1/I2C0_SDA/TPM1_CH1, label: 'J10[4]/A1', identifier: N;NYellow}
...
- {pin_num: '55', pin_signal: ADC0_SE14/TSI0_CH13/PTC0/EXTRG_IN/CMP0_OUT, label: 'J1[3]', identifier: EBlue}
- {pin_num: '57', pin_signal: ADC0_SE11/TSI0_CH15/PTC2/I2C1_SDA/TPM0_CH1, label: 'J10[10]/A4', identifier: NSensor;NSense}
- {pin_num: '58', pin_signal: PTC3/LLWU_P7/UART1_RX/TPM0_CH2/CLKOUTa, label: 'J1[5]', identifier: ERed}
- {pin_num: '61', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/TPM0_CH3, label: 'J1[7]', identifier: EYellow}
- {pin_num: '62', pin_signal: PTC5/LLWU_P9/SPI0_SCK/LPTMR0_ALT2/CMP0_OUT, label: 'J1[9]', identifier: EGreen}
- {pin_num: '64', pin_signal: CMP0_IN1/PTC7/SPI0_MISO/SPI0_MOSI, label: 'J1[1]', identifier: ESensor;ESense}
- {pin_num: '65', pin_signal: CMP0_IN2/PTC8/I2C0_SCL/TPM0_CH4, label: 'J1[14]', identifier: WBlue}
- {pin_num: '66', pin_signal: CMP0_IN3/PTC9/I2C0_SDA/TPM0_CH5, label: 'J1[16]', identifier: WSense}
- {pin_num: '77', pin_signal: PTD4/LLWU_P14/SPI1_PCS0/UART2_RX/TPM0_CH4, label: 'J1[6]/D2', identifier: WBlue;WRed}
...
- pin_list:
  ...
  - {pin_num: '57', peripheral: GPIOC, signal: 'GPIO, 2', pin_signal: ADC0_SE11/TSI0_CH15/PTC2/I2C1_SDA/TPM0_CH1, identifier: NSense, direction: INPUT, pull_enable: enable}
  - {pin_num: '13', peripheral: GPIOE, signal: 'GPIO, 20', pin_signal: ADC0_DP0/ADC0_SE0/PTE20/TPM1_CH0/UART0_TX, identifier: SGreen, direction: OUTPUT}
  ...
  - {pin_num: '21', peripheral: GPIOE, signal: 'GPIO, 29', pin_signal: CMP0_IN5/ADC0_SE4b/PTE29/TPM0_CH2/TPM_CLKIN0, identifier: SSense, direction: INPUT, pull_enable: enable}
  ...
  - {pin_num: '64', peripheral: GPIOC, signal: 'GPIO, 7', pin_signal: CMP0_IN1/PTC7/SPI0_MISO/SPI0_MOSI, identifier: ESense, direction: INPUT, pull_enable: enable}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITPINS_WGreen_GPIO, BOARD_INITPINS_WGreen_PIN, &WGreen_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_WYellow_GPIO, BOARD_INITPINS_WYellow_PIN, &WYellow_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_NGreen_GPIO, BOARD_INITPINS_NGreen_PIN, &NGreen_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_NYellow_GPIO, BOARD_INITPINS_NYellow_PIN, &NYellow_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_NRed_GPIO, BOARD_INITPINS_NRed_PIN, &NRed_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_NBlue_GPIO, BOARD_INITPINS_NBlue_PIN, &NBlue_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_EBlue_GPIO, BOARD_INITPINS_EBlue_PIN, &EBlue_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_NSense_GPIO, BOARD_INITPINS_NSense_PIN, &NSense_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_ERed_GPIO, BOARD_INITPINS_ERed_PIN, &ERed_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_EYellow_GPIO, BOARD_INITPINS_EYellow_PIN, &EYellow_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_EGreen_GPIO, BOARD_INITPINS_EGreen_PIN, &EGreen_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_WRed_GPIO, BOARD_INITPINS_WRed_PIN, &WRed_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_SGreen_GPIO, BOARD_INITPINS_SGreen_PIN, &SGreen_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_SYellow_GPIO, BOARD_INITPINS_SYellow_PIN, &SYellow_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_SRed_GPIO, BOARD_INITPINS_SRed_PIN, &SRed_config);
    ...
    GPIO_PinInit(BOARD_INITPINS_SBlue_GPIO, BOARD_INITPINS_SBlue_PIN, &SBlue_config);
    ...
    PORT_SetPinMux(BOARD_INITPINS_NGreen_PORT, BOARD_INITPINS_NGreen_PIN, kPORT_MuxAsGpio);

    /* PORTB1 (pin 44) is configured as PTB1 */
    PORT_SetPinMux(BOARD_INITPINS_NYellow_PORT, BOARD_INITPINS_NYellow_PIN, kPORT_MuxAsGpio);

    /* PORTB2 (pin 45) is configured as PTB2 */
    PORT_SetPinMux(BOARD_INITPINS_NRed_PORT, BOARD_INITPINS_NRed_PIN, kPORT_MuxAsGpio);

    /* PORTB3 (pin 46) is configured as PTB3 */
    PORT_SetPinMux(BOARD_INITPINS_NBlue_PORT, BOARD_INITPINS_NBlue_PIN, kPORT_MuxAsGpio);

    /* PORTC0 (pin 55) is configured as PTC0 */
    PORT_SetPinMux(BOARD_INITPINS_EBlue_PORT, BOARD_INITPINS_EBlue_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinConfig(BOARD_INITPINS_NSense_PORT, BOARD_INITPINS_NSense_PIN, &NSense);

    /* PORTC3 (pin 58) is configured as PTC3 */
    PORT_SetPinMux(BOARD_INITPINS_ERed_PORT, BOARD_INITPINS_ERed_PIN, kPORT_MuxAsGpio);

    /* PORTC4 (pin 61) is configured as PTC4 */
    PORT_SetPinMux(BOARD_INITPINS_EYellow_PORT, BOARD_INITPINS_EYellow_PIN, kPORT_MuxAsGpio);

    /* PORTC5 (pin 62) is configured as PTC5 */
    PORT_SetPinMux(BOARD_INITPINS_EGreen_PORT, BOARD_INITPINS_EGreen_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_INITPINS_SGreen_PORT, BOARD_INITPINS_SGreen_PIN, kPORT_MuxAsGpio);

    /* PORTE21 (pin 14) is configured as PTE21 */
    PORT_SetPinMux(BOARD_INITPINS_SYellow_PORT, BOARD_INITPINS_SYellow_PIN, kPORT_MuxAsGpio);

    /* PORTE22 (pin 15) is configured as PTE22 */
    PORT_SetPinMux(BOARD_INITPINS_SRed_PORT, BOARD_INITPINS_SRed_PIN, kPORT_MuxAsGpio);

    /* PORTE23 (pin 16) is configured as PTE23 */
    PORT_SetPinMux(BOARD_INITPINS_SBlue_PORT, BOARD_INITPINS_SBlue_PIN, kPORT_MuxAsGpio);
